...
public class Animal implements Comparable<Animal> {
    ...
    public Animal(Simulation simulation, int startEnergy, Position position, Genome genome, Animal[] parents) {
        this.sim = simulation;
        ...
        if (parents!=null){
            parents[0].addDescendant(this);
            parents[1].addDescendant(this);
        }
    }
    ...
    public void addDescendant(Animal descendant){
        ...
        if (parents!=null){
            parents[0].addDescendant(descendant);
            parents[1].addDescendant(descendant);
        }
    }
